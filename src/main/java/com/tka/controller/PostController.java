...
import com.tka.Services.PostService;
...
public class PostController {
	...
	public ResponseEntity<Post> savedPostByIdHandler(@PathVariable Integer postId,
			@RequestHeader("Authorization") String jwt) throws Exception{
	...
	public ResponseEntity<Post> likedPostByIdHandler(@PathVariable Integer postId, 
			@RequestHeader("Authorization") String jwt) throws Exception{
